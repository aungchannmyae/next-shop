          ...
          <div className="">
            ...
            <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                ...
                <div className="mb-6 grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2 sm:col-span-1">
                    ...
                    <input
                      ...
                      className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-sm text-gray-900 focus:border-purple-500 focus:ring-purple-500  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-purple-500 dark:focus:ring-purple-500"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="text"
                        className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-9 text-sm text-gray-900 focus:border-purple-500 focus:ring-purple-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-purple-500 dark:focus:ring-purple-500"
                        placeholder="12/23"
                        required
                      />
                    </div>
              ...
              <div className="mt-6 grow sm:mt-8 lg:mt-0">
                <OrderSummary btnName={"Pay Now"} link={"/order-confirm"} />
            ...
            <p className="mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8 lg:text-left">
              ...
              <Link
                href="#"
                title=""
                className="font-medium text-purple-700 underline hover:no-underline dark:text-purple-500"
              >
                Paddle
              </Link>{" "}
              for{" "}
